<script>
  import KatzenCard from "$lib/components/KatzenCard.svelte";
  export let data;
...
<div class="button-container">
  ...
  <a href="/katzen/create" class="btn btn-primary my-btn">Katze hinzufügen</a>
